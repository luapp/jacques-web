...
function Bio() {
    return (
        <div className={BioCss.bio}>
            <Header />
            <div className={BioCss.bio_grid}>
                <div className={BioCss.Section_one_pic_box}>
                    <img className={BioCss.profil_pic} src={profil_pic} alt="Profile" />
                </div>
                <div className={BioCss.bio_text}>
                    <h1 className={BioCss.bio_h1}>Biography</h1>
                    <br/>
                    <p className={BioCss.bio_p}>
